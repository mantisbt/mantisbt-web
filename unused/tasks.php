...
<tr bgcolor="#ddddff">
	<td colspan="3">
		<b><?php echo $v_title ?></b> - <span class="news_date">[ <?php echo $v_date_posted ?> ]</span>
	</td>
</tr>
<tr bgcolor="#ddddee">
	<td>
		Assigned to: <i><?php echo $v_user ?></i>
	</td>
	<td>
		Hours remaining: <b><?php echo $v_work_left ?></b>
	</td>
	<td>
		Scheduled for: <b><?php echo $v_milestone ?></b>
	</td>
</tr>
<tr bgcolor="#ffffff">
	<td colspan="3">
