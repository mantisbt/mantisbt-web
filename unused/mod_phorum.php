...
<p>
<ul>
	<li><a href="images/phorum1.gif">view screenshot</a> - <?php echo round(filesize("images/phorum1.gif") / 1024) ?> KB - Sorry about the blurred text.  My camera was out of focus.
</ul>
