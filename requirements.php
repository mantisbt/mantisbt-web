...
<p>Mantis runs on Windows, MacOS, OS/2, Linux, Solaris, the BSDs, and just about anything that supports the required server software.</p>
<p>Mantis has very modest software and hardware requirements.  You need a computer to run the server on along with the server software.  All of the required software is free for commercial or non-commercial use.</p>
...
<br />
<span class="section">Software (for Mantis 1.1.x)</span>
<ul>
...
<span class="section">Software (for Mantis 1.2.x)</span>
<ul>
...
<p>Mantis is free. The net cost to use Mantis is the time to download, install, and configure the software plus any potential hardware costs.  Continued maintenance should be minimal unless you are customizing the package.  You can also use the Mantis team's consulting services to customize or enhance Mantis for your company's specific needs.</p>
<br />
...
to evaluate Mantis or to run a small installation, then you should be up and running in 5 minutes even if you have never touch a webserver or PHP before.</p>
<br />
<span class="section">PHP</span>
<p>You don't have to know a thing about PHP to use Mantis.  However, it always helps to be able to tinker with PHP scripts.</p>
