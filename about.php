...
<p>
Check the <a href="roadmap.php">Roadmap</a> for a more detailed and somewhat up to date list of items.
...
<p>
<ul>
	<li>Report any bugs at the <a href="demo.php">Demo Bugtracker</a>
	<li>Suggest (reasonable) features
	<li>Give feedback and visit the <a href="polls.php">polls</a> or <a href="survey.php">surveys</a>
