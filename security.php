...
<p>
Below is a listing of all known security problems in MantisBT releases. If you discover a problem not listed below, please contact <a href="mailto:mantisbt-security@lists.sourceforge.net">the MantisBT Team</a>.
<p>
...
<p>
Through GET, POST, or COOKIE variables a user may be able to take advantage of remote script execution. This has been fixed in MantisBT 0.17.4.
...
<p>
Through manipulation of cookies it is possible to set a user's current project to a private project, and access the 'View Bugs' page. This has been fixed in MantisBT 0.17.4.
...
<p>
There is an option in MantisBT which limits the bug reports shown to reporters. This option was not checked on the 'Print Reports' page. This has been fixed in CVS, and will appear in 0.18.0.
...
<p>
Upgrade to MantisBT 0.17.3 if you do not have magic_quotes_gpc enabled in your PHP installation. Input was not checked in account_update.php (and a lot of other files), which allowed anyone with an account on the system to become administrator in your MantisBT installation. Input validation has been added to account_update.php for 0.17.3, and for all other files in the upcoming 0.18.0 (or in CVS).

<p>
<span class="section">File Uploads</span> - <font color=#ff0000>Security Problem</font>
<p>
Upgrade to MantisBT 0.15.11 if you use file uploads.  Files were not being checked for their permissions.  By default many Apache installations create /tmp/ directory files as world executable (777).  Files are now umasked before being copied.

<p>
<span class="section">File Uploads</span> - <font color=#ff0000>Security Problem</font>
<p>
Upgrade to MantisBT 0.15.6 if you use file uploads.  A user may be able to gain read access to any file on your server.  The release requries you to have PHP 3.0.17 or higher.
